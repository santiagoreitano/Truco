...
public class Cartas {
    ...
    return valor;  
        ...
        public static void mostrarCarta(Cartas a){
            ...
            else if (a.pinta == 0 )System.out.println(a.numero+ " de 0");
    ...
    for(int i=0;i<6;i++){
        ...
        public static Cartas jugarCarta3(Jugadoor persona1,Jugadoor persona2){
        Cartas resul;
        int carta;
        ...
        resul=persona1.mazo[carta-1];
            ...
            mostrarCarta(resul);
            agregarCarta1(persona1.mazo[carta-1],persona2);
            sacarCarta1(carta-1,persona1.mazo);
        return resul; 
    }
        
        
        public static Cartas jugarCarta2(Jugadoor persona1,Jugadoor persona2){
        Cartas resul;
        int carta;
        ...
        public static Cartas jugarCarta1(Jugadoor persona1,Jugadoor persona2){
        Cartas resul;
        int carta;
    ...
    cartas[1]=null;
        ...
        public static void agregarCarta1(Cartas carta,Jugadoor jugador ){
            
            for(int i=0;i<jugador.jugadas.length;i++){
                if(jugador.jugadas[i].numero==0 && jugador.jugadas[i].pinta==0){
                    jugador.jugadas[i]=carta;
